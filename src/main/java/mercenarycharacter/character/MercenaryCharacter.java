package mercenarycharacter.character;
...
import static mercenarycharacter.TheMercenaryMod.characterPath;
import static mercenarycharacter.TheMercenaryMod.makeID;

public class MercenaryCharacter extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Mercenary"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass CHINAG_MERCENARY;
        @SpireEnum(name = "STEEL") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "STEEL") @SuppressWarnings("unused")
        ...
        private static final Color cardColor = new Color(202f/255f, 204f/255f, 206f/255f, 1f);
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new MercenaryCharacter(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public MercenaryCharacter() {
        super(getNames()[0], Meta.CHINAG_MERCENARY,
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(DualStrike.ID);
        retVal.add(Mettle.ID);
...
private final Color cardRenderColor = Color.GRAY.cpy(); //Used for some vfx on moving cards (sometimes) (maybe)
    private final Color cardTrailColor = Color.GRAY.cpy(); //Used for card trail vfx during gameplay.
    private final Color slashAttackColor = Color.GRAY.cpy(); //Used for a screen tint effect when you attack the heart.
    @Override
