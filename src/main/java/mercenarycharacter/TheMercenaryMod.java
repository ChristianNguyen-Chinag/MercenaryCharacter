...
public class TheMercenaryMod implements
    ...
    public static void initialize() {
        ...
        MercenaryCharacter.Meta.registerColor();
    }

    public TheMercenaryMod() {
    ...
    private static String checkResourcesPath() {
        String name = TheMercenaryMod.class.getName(); //getPackage can be iffy with patching, so class name is used instead.
        ...
        throw new RuntimeException("\n\tFailed to find resources folder; expected it to be named \"" + name + "\"." +
                ...
                "\t\"private static final String resourcesFolder = checkResourcesPath();\"\n" +
                "\tat the top of the " + TheMercenaryMod.class.getSimpleName() + " java file.");
    }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(TheMercenaryMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
    ...
    public void receiveEditCharacters() {
        MercenaryCharacter.Meta.registerCharacter();
    }
