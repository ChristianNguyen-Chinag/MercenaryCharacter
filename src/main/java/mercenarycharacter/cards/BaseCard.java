package mercenarycharacter.cards;

import basemod.BaseMod;
import basemod.abstracts.CustomCard;
import basemod.abstracts.DynamicVariable;
import mercenarycharacter.TheMercenaryMod;
import mercenarycharacter.util.CardStats;
import mercenarycharacter.util.TriFunction;
...
import static mercenarycharacter.util.GeneralUtils.removePrefix;
import static mercenarycharacter.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return TheMercenaryMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    TheMercenaryMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
